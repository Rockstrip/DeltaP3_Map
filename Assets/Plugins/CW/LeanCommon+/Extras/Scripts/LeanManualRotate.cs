...
namespace Lean.Common
{
	...
	public class LeanManualRotate : MonoBehaviour
	{
		...
		public GameObject Target { set { target = value; } get { return target; } } [SerializeField] protected GameObject target;

		/// <summary>This allows you to set the coordinate space the rotation will use.</summary>
		public Space Space { set { space = value; } get { return space; } } [SerializeField] protected Space space;

		/// <summary>The first rotation axis, used when calling RotateA or RotateAB.</summary>
		public Vector3 AxisA { set { axisA = value; } get { return axisA; } } [SerializeField] protected Vector3 axisA = Vector3.down;

		/// <summary>The second rotation axis, used when calling RotateB or RotateAB.</summary>
		public Vector3 AxisB { set { axisB = value; } get { return axisB; } } [SerializeField] protected Vector3 axisB = Vector3.right;

		/// <summary>If you want this component to rotate an object relative to a camera, enable this setting.</summary>
		public bool RotateAxesToCamera { set { rotateAxesToCamera = value; } get { return rotateAxesToCamera; } } [SerializeField] protected bool rotateAxesToCamera;
		...
		public float Multiplier { set { multiplier = value; } get { return multiplier; } } [SerializeField] protected float multiplier = 1.0f;

		/// <summary>If you want this component to change smoothly over time, then this allows you to control how quick the changes reach their target value.
		/// -1 = Instantly change.
		/// 1 = Slowly change.
		/// 10 = Quickly change.</summary>
		public float Damping { set { damping = value; } get { return damping; } } [SerializeField] protected float damping = 10.0f;
		...
		public bool ScaleByTime { set { scaleByTime = value; } get { return scaleByTime; } } [SerializeField] protected bool scaleByTime;

		/// <summary>If you call the ResetRotation method, the rotation will be set to this Euler rotation.</summary>
		public Vector3 DefaultRotation { set { defaultRotation = value; } get { return defaultRotation; } } [SerializeField] protected Vector3 defaultRotation;

		[SerializeField]
		protected Quaternion remainingDelta = Quaternion.identity;
		...
		public virtual void RotateAB(Vector2 delta)
		{
			var finalTransform = target != null ? target.transform : transform;
			var oldRotation    = finalTransform.localRotation;
		...
		protected virtual void UpdateRotation(float factor)
		{
			var finalTransform = target != null ? target.transform : transform;
			var newDelta       = Quaternion.Slerp(remainingDelta, Quaternion.identity, factor);
			var nextStep = finalTransform.localRotation * Quaternion.Inverse(newDelta) * remainingDelta;

			finalTransform.localRotation = nextStep;
