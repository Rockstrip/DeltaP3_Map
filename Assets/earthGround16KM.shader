Shader "Custom/EarthGround16K" {
    ...
    SubShader {  
        ...
        CGPROGRAM
		#pragma surface surf BlinnPhongEditor exclude_path:prepass Lambert alpha vertex:vert
        ...
        void surf (Input IN, inout EditorSurfaceOutput o) {  
        	...
        	float2 equiUV = RadialCoords(IN.vertexNormal);
            ...
            o.Albedo = (color+ Multiply1)*_Brightness;
            //o.Albedo = (1.0f,1.0f,1.0f);
